...
function guessCountryFlag(v) {
  ...
  const rules = [
    ...
    { k: ['brunei','文莱'], f: '🇧🇳' },
    { k: ['timor-leste','east timor','东帝汶'], f: '🇹🇱' },
    ...
    { k: ['turkey','türkiye','土耳其','ankara','istanbul'], f: '🇹🇷' },
    { k: ['qatar','卡塔尔','doha'], f: '🇶🇦' },
    { k: ['kuwait','科威特'], f: '🇰🇼' },
    { k: ['bahrain','巴林'], f: '🇧🇭' },
    { k: ['oman','阿曼','muscat'], f: '🇴🇲' },
    ...
    { k: ['belize','伯利兹'], f: '🇧🇿' },
    { k: ['trinidad and tobago','特立尼达和多巴哥'], f: '🇹🇹' },
    { k: ['barbados','巴巴多斯'], f: '🇧🇧' },
    { k: ['bahamas','巴哈马'], f: '🇧🇸' },
    { k: ['grenada','格林纳达'], f: '🇬🇩' },
    ...
    { k: ['niger ','尼日尔 '], f: '🇳🇪' },
    { k: ['cameroon','喀麦隆'], f: '🇨🇲' },
    { k: ['ivory coast','côte d\'ivoire','科特迪瓦'], f: '🇨🇮' },
    { k: ['gabon','加蓬'], f: '🇬🇦' },
