...
function guessCountryFlag(v) {
  ...
  const rules = [
    // 东亚
    { k: ['china','cn','中国','beijing','shanghai','guangzhou'], f: '🇨🇳' },
    { k: ['hong kong','hk','香港'], f: '🇭🇰' },
    { k: ['macau','macao','澳门'], f: '🇲🇴' },
    { k: ['taiwan','台灣','台湾'], f: '🇹🇼' },
    { k: ['japan','tokyo','日本'], f: '🇯🇵' },
    { k: ['korea','south korea','首尔','韓國','韩国'], f: '🇰🇷' },
    { k: ['north korea','朝鲜'], f: '🇰🇵' },
    ...
    // 北美
    { k: ['united states','usa','america','los angeles','new york','美国'], f: '🇺🇸' },
    { k: ['canada','toronto','加拿大'], f: '🇨🇦' },
    { k: ['mexico','墨西哥'], f: '🇲🇽' },
